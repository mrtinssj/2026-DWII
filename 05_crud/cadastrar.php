...
<div class="container">
    ...
    <div class="form-container">
        <form action="cadastrar.php" method="post">
            ...
            <label for="descricao">Descrição: <span style="color:
            #cf1c21;">*</span></label>
            <textarea id="descricao"
                      name="descricao"
                      rows="4"
                      placeholder="Descreva o projeto em 2-3
                      frases..."><?php echo htmlspecialchars($form
                      ['descricao']); ?></textarea>
            ...
            <label for="link_github">Link do GitHub: <span
